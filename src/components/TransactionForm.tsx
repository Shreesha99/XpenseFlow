              ...
              <div className="bg-emerald-500/5 border border-emerald-500/20 rounded-2xl p-4 space-y-3">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-[10px] text-muted-foreground leading-relaxed">
                      <span className="text-blue-500 font-bold">Digital:</span>{" "}
            ...
            <button
              ...
              className={`flex-1 flex items-center justify-center gap-2 py-3 rounded-xl text-[10px] font-bold uppercase tracking-widest transition-all duration-300 ${
                formData.type === "expense"
                  ? "bg-rose-600 text-white shadow-lg shadow-rose-500/20 scale-[1.02]"
                  : "text-muted-foreground hover:text-foreground hover:bg-card"
              }`}
            >
        ...
        <div className="space-y-2">
          ...
          <div className="flex gap-2 p-1 bg-muted border border-border rounded-2xl">
            ...
            <button
              ...
              className={`flex-1 flex items-center justify-center gap-2 py-3 rounded-xl text-[10px] font-bold uppercase tracking-widest transition-all duration-300 ${
                formData.mode === "in_hand"
                  ? "bg-amber-600 text-white shadow-lg shadow-amber-500/20 scale-[1.02]"
                  : "text-muted-foreground hover:text-foreground hover:bg-card"
              }`}
            >
        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full p-4 pl-10 rounded-2xl bg-muted border border-border text-foreground text-sm outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500/50 transition-all placeholder:text-muted-foreground"
        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full p-4 pl-10 rounded-2xl bg-muted border border-border text-foreground text-sm outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500/50 transition-all"
            />
          </div>
        </div>
        <div className="space-y-2">
