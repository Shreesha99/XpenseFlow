    ...
    >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          <div
            id="tour-settings-accounts"
            className="bg-card border border-border rounded-[2.5rem] p-8 shadow-sm overflow-hidden relative group"
          >
        ...
        <div className="space-y-6">
          <div
            id="tour-settings-preferences"
            className="bg-card border border-border rounded-[2.5rem] p-8 shadow-sm space-y-8"
          >
            <div className="space-y-1">
          ...
          <div
            id="tour-settings-security"
            className="bg-emerald-600 rounded-[2.5rem] p-8 text-white shadow-xl shadow-emerald-500/20 relative overflow-hidden group"
          >
